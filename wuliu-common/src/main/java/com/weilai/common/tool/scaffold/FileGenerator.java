...
public class FileGenerator {
	private final static String TEMPLATE_PATH = "com/"+ScaffoldGenerator.COMPANY_NAME+"/common/tool/scaffold/template/";
	...
	public static void main(String[] args) {
		FileGenerator gen = new FileGenerator("com."+ScaffoldGenerator.COMPANY_NAME, "UserDAO", "DAO.txt", new HashMap<String, String>());
		gen.execute();
	}
}
